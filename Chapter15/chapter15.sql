...
SELECT * FROM employees_tax_dept; --where clause condition must be met to change data
...
VALUES ('Suzanne', 'Legere', 1);--will work

INSERT INTO employees_tax_dept (first_name, last_name, dept_id)
VALUES ('Jamil', 'White', 2);--wont work as it violates the where clause
...
RETURNS void AS $$ -- function returns data
BEGIN
    UPDATE teachers
    SET personal_days = --case used to clarify values
...
$$
BEGIN
    IF NEW.grade <> OLD.grade THEN -- function triggered when gradde is changed
